;;; Version 1.1
;;; Date 2022年  1月 29日 土曜日 00:08:39 JST
;;; =====================================包定义区=====================================
                     ...
                     (cond ((char= #\# (aref obj 0))
                           ...
                           ((member (aref obj 0) '(#\0 #\1 #\x #\z))
                            (let* (;; 读取变量标识符
                                   ...
                                   (value_list (gethash 0 (gethash identifier_code value_changes_ht)))
                           ...
                           ((char= #\b (aref obj 0))
                            (let* (;; 从下一个单词读取变量标识符
                              ...
                              (do ((i 0 (1+ i)))
                                ...
                                (let* ((value_list (gethash i (gethash identifier_code value_changes_ht)))
                                       (simulation_time_old (nth 0 (car value_list)))
                                       (scalar_value_old (nth 1 (car value_list)))
