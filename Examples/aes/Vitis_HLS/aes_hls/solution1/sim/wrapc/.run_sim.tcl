...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "aes_encrypt.autotvin.dat"
	set constFileTvOut       "aes_encrypt.autotvout.dat"
	set constFileHdlTvIn     "aes_encrypt.autohdltvin.dat"
	set constFileHdlTvOut    "aes_encrypt.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
