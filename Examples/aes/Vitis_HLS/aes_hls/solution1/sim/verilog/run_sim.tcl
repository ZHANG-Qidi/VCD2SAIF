...
if {[file isfile aes_encrypt.autotvin.dat]} {
	file delete -force aes_encrypt.autotvin.dat
}

if {[file isfile aes_encrypt.autotvout.dat]} {
	file delete -force aes_encrypt.autotvout.dat
}
