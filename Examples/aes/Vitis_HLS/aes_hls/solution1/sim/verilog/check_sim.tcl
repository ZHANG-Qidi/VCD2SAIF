...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.aes_encrypt.autotvin_statemt256.dat"
         "c.aes_encrypt.autotvin_key256.dat"
         "c.aes_encrypt.autotvin_type_r.dat"
         "c.aes_encrypt.autotvout_statemt256.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.aes_encrypt.autotvout_statemt256.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
