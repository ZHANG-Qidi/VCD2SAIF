; ModuleID = '/home/grunt/Vitis_HLS/aes_hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%struct.ssdm_int = type { i256 }

; Function Attrs: noinline
define void @apatb_aes_encrypt_ir(%struct.ap_uint* %statemt256, %struct.ap_uint* nocapture readonly %key256, i32 %type) local_unnamed_addr #0 {
entry:
  %statemt256_copy1 = alloca %struct.ap_uint, align 512
  call fastcc void @copy_in(%struct.ap_uint* %statemt256, %struct.ap_uint* nonnull align 512 %statemt256_copy1)
  call void @apatb_aes_encrypt_hw(%struct.ap_uint* %statemt256_copy1, %struct.ap_uint* %key256, i32 %type)
  call fastcc void @copy_out(%struct.ap_uint* %statemt256, %struct.ap_uint* nonnull align 512 %statemt256_copy1)
  ret void
}
...
; <label>:14:                                     ; preds = %11
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %15, i8* align 1 %5, i64 32, i1 false)
  br label %ret
...
declare void @apatb_aes_encrypt_hw(%struct.ap_uint*, %struct.ap_uint*, i32)

define void @aes_encrypt_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*, i32) #6 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %0)
  call void @aes_encrypt_hw_stub(%struct.ap_uint* %0, %struct.ap_uint* %1, i32 %2)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %0)
  ret void
}

declare void @aes_encrypt_hw_stub(%struct.ap_uint*, %struct.ap_uint*, i32)
