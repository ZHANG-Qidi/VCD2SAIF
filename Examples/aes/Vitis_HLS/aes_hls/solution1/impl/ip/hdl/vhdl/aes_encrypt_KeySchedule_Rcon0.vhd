...
entity aes_encrypt_KeySchedule_Rcon0_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 30
...
architecture rtl of aes_encrypt_KeySchedule_Rcon0_rom is 
...
entity aes_encrypt_KeySchedule_Rcon0 is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes_encrypt_KeySchedule_Rcon0 is
    component aes_encrypt_KeySchedule_Rcon0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_encrypt_KeySchedule_Rcon0_rom_U :  component aes_encrypt_KeySchedule_Rcon0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
