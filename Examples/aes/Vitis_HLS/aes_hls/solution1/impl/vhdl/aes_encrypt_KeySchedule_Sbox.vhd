...
entity aes_encrypt_KeySchedule_Sbox_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes_encrypt_KeySchedule_Sbox_rom is 
...
entity aes_encrypt_KeySchedule_Sbox is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes_encrypt_KeySchedule_Sbox is
    component aes_encrypt_KeySchedule_Sbox_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_encrypt_KeySchedule_Sbox_rom_U :  component aes_encrypt_KeySchedule_Sbox_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
