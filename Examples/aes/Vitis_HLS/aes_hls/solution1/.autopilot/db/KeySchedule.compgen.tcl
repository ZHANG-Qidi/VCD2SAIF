...
set id 1
set name aes_encrypt_mul_4ns_4ns_8_1_1
...
set id 2
set name aes_encrypt_urem_7ns_4ns_3_11_1
...
set id 3
set name aes_encrypt_udiv_7ns_4ns_5_11_1
...
set ID 7
set hasByteEnable 0
set MemName aes_encrypt_KeySchedule_Sbox
...
set ID 8
set hasByteEnable 0
set MemName aes_encrypt_KeySchedule_Rcon0
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 30
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename word \
    op interface \
    ports { word_address0 { O 9 vector } word_ce0 { O 1 bit } word_we0 { O 1 bit } word_d0 { O 8 vector } word_q0 { I 8 vector } word_address1 { O 9 vector } word_ce1 { O 1 bit } word_we1 { O 1 bit } word_d1 { O 8 vector } word_q1 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'word'"
}
}
