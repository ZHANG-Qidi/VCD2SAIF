# 1 "aes_hls/src/common/aes_AddRoundKey.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "aes_hls/src/common/aes_AddRoundKey.cpp" 2
# 1 "aes_hls/src/common/aes_AddRoundKey.h" 1


int AddRoundKey(unsigned char statemt[32], int type, unsigned char n, unsigned char word[4][120]);
# 2 "aes_hls/src/common/aes_AddRoundKey.cpp" 2
...
int AddRoundKey(unsigned char statemt[32], int type, unsigned char n, unsigned char word[4][120]) {
  ...
  VITIS_LOOP_25_1: for (j = 0; j < nb; ++j) {
