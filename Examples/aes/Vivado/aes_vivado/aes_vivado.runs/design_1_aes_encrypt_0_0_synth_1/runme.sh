...
HD_PWD='/home/grunt/Vivado/aes_vivado/aes_vivado.runs/design_1_aes_encrypt_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_aes_encrypt_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_aes_encrypt_0_0.tcl
